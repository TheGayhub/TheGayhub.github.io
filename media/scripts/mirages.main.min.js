...
[].forEach.call(a,function(a){var b=a.dataset.src;b&&(a.src=b,a.removeAttribute("data-src"))})}};"undefined"!==typeof module&&"undefined"!==typeof module.exports?module.exports=a:window.OwO=a})();var $jscomp={scope:{},findInternal:function(a,h,f){a instanceof String&&(a=String(a));for(var g=a.length,k=0;k<g;k++){var l=a[k];if(h.call(f,l,k,a))return{i:k,v:l}}return{i:-1,v:void 0}}};$jscomp.defineProperty="function"==typeof Object.defineProperties?Object.defineProperty:function(a,h,f){if(f.get||f.set)throw new TypeError("ES3 does not support getters and setters.");a!=Array.prototype&&a!=Object.prototype&&(a[h]=f.value)};
...
(function(a){var h=0,f=!1,g={};"touchmove"in document.createElement("div")&&(f=!0);a(document).ready(function(){I();J();if("undefined"===typeof LocalConst.IS_MOBILE)return!1;888>window.innerWidth&&((new Headroom(document.querySelector("#toggle-nav"),{tolerance:5,offset:5,classes:{initial:"show",pinned:"show",unpinned:"hide"}})).init(),(new Headroom(document.querySelector("body"),{tolerance:5,offset:5,classes:{initial:"auto-hide-show",pinned:"auto-hide-show",unpinned:"auto-hide-hide"}})).init());K();
L();z();a(window).bind("scroll",function(b){b=a("#wrap");b.find("#nav").width()<h&&(LocalConst.IS_MOBILE&&f||!LocalConst.IS_MOBILE)&&(a("#wrap.display-nav").find("#body").unbind("click"),b.removeClass("display-nav"),a("body").removeClass("display-nav"),a("#nav-toolbar").find(".side-toolbar").removeClass("show-read-settings"),a("#footer").removeClass("display-nav"));t()});a(window).bind("mousemove",function(a){h=a.clientX});a(".slide-toggle").click(function(b){a(".category-list").each(function(){a(this).toggleClass("hide")})});
A();M();N();O();a(".blog-notice>a.blog-notice-close").click(function(b){a(this).parent().remove()});LocalConst.COMMENT_SYSTEM===LocalConst.COMMENT_SYSTEM_EMBED&&B();C()});window.onload=function(){D(200)};console.log("\n %c Mirages "+LocalConst.THEME_VERSION+" %c https://get233.com/archives/mirages-intro.html \n\n","color: #fff; background-image: linear-gradient(90deg, rgb(47, 172, 178) 0%, rgb(45, 190, 96) 100%); padding:5px 1px;","background-image: linear-gradient(90deg, rgb(45, 190, 96) 0%, rgb(255, 255, 255) 100%); padding:5px 0;");
var k={},l=[],u=!0,E=1,J=function(){var b=a("span#backtop"),c=a("body");b.click(function(){a("html, body").animate({scrollTop:0},600)});100<a(window).scrollTop()&&c.addClass("show-back-to-top");a(window).scroll(function(){100<a(window).scrollTop()?c.addClass("show-back-to-top"):c.removeClass("show-back-to-top")})},v=function(){var b=0,c=a(".navbar");c&&!c.is(":hidden")&&(b=c.innerHeight());return b},P=function(a,c){var b=document.body,e=document.documentElement,m=function(){return Math.max(b.scrollHeight,
b.offsetHeight,e.clientHeight,e.scrollHeight,e.offsetHeight)},g=m(),f;(function w(){f=m();g!==f&&c();g=f;b.onElementHeightChangeTimer&&clearTimeout(b.onElementHeightChangeTimer);b.onElementHeightChangeTimer=setTimeout(w,a)})()},I=function(){a("#feedback").click(function(){a("html, body").animate({scrollTop:a("#comments").offset().top})})},K=function(){a("#toggle-nav").off("click").on("click",function(b){var c=a("#wrap"),d=a("body");c.removeClass("scale-up").toggleClass("display-nav");d.toggleClass("display-nav");
...
function(b){if("undefined"===typeof ExSearchConfig){b=a("body");var c=a(".navbar-search-container .search-form > input.search");b.hasClass("show-navbar-search")?(b.removeClass("show-navbar-search"),c.focusout()):(b.addClass("show-navbar-search"),c.focus())}})},L=function(){a('a.dropdown-toggle[data-toggle="dropdown"]').off("click").on("click",function(c){var d=a(this).parent(".dropdown").children(".dropdown-menu");d&&(d.hasClass("show")?d.removeClass("show"):(b(),d.addClass("show"),setTimeout(function(){var b=
a("#body, .navbar");b.off("click").on("click",function(a){b.off("click");d.removeClass("show");F()})},100)));c.preventDefault()});a(".dropdown-item > a, .nav-item:not(.dropdown) > .nav-link").off("click").on("click",function(a){b()});var b=function(){F();a('a.dropdown-toggle[data-toggle="dropdown"]').each(function(){var b=a(this).parent(".dropdown").find(".dropdown-menu");b&&b.removeClass("show")})}},C=function(){if(LocalConst.ENABLE_PJAX)a("#comment-form").off("submit").on("submit",function(b){var c=
a(this),d=c.find("#submit"),e=c.parents(".respond").parent(),m=c.find("#author").val();b=c.find("#url").val();var f=c.find("#textarea").val();if(null===f||""===a.trim(f))return alert(d.attr("data-empty-comment")),!1;0===c.find("#author").length&&0===c.find("#url").length&&(m=a('a[href$="profile.php"]').text(),b=document.location.origin);d.attr("disabled","disabled").val(d.attr("data-posting"));var h="newComment-"+E;E++;b='<li itemscope="" itemtype="http://schema.org/UserComments" id="'+h+'" class="comment-body"><div class="comment-author" itemprop="creator" itemscope="" itemtype="http://schema.org/Person"><span itemprop="image"><img class="avatar" src="'+
LocalConst.BASE_SCRIPT_URL+'images/spinner.svg" alt="'+m+'" width="100" height="100"></span><cite class="fn color-main" itemprop="name"><a href="'+b+'" rel="external nofollow" target="_blank">'+m+'</a></cite></div><div class="comment-meta"><a href="javascript:void(0)"><time itemprop="commentTime" datetime="'+d.attr("data-now")+'">'+d.attr("data-now")+'</time></a><span id="'+h+'-status" class="comment-posting">'+d.attr("data-posting")+'</span></div><div class="comment-content" itemprop="commentText"><p>'+
q(Q(f),g.owoData)+"</p></div></li>";var k=f=!1,w="DESC"===LocalConst.COMMENTS_ORDER;e.is("div")&&"comments"===e.attr("id")?(0<e.children(".comment-list").length?w?e.children(".comment-list").first().prepend(b):e.children(".comment-list").first().append(b):(e.append('<div class="comment-separator"><div class="comment-tab-current"><span class="comment-num">\u5df2\u6709 1 \u6761\u8bc4\u8bba</span></div></div>'),e.append('<ol class="comment-list">'+b+"</ol>"),k=!0),f=!0):e.is("li")&&e.hasClass("comment-body")&&
(e.parent().parent().is("div")&&"comments"===e.parent().parent().attr("id")?0<e.children(".comment-children").first().children(".comment-list").length?e.children(".comment-children").first().children(".comment-list").first().append(b):e.append('<div class="comment-children" itemprop="discusses"><ol class="comment-list">'+b+"</ol></div>"):e.parents(".comment-list").first().append(b),f=!0);if(f){var r=v();try{var n=a("#"+h).offset();"undefined"!==typeof n&&a("html, body").animate({scrollTop:n.top-50-
r},300)}catch(y){console.error(y)}var l=function(){try{k?(e.children(".comment-separator").first().remove(),e.children(".comment-list").first().remove()):a("#"+h).remove();var b=a("#comment-form").offset();"undefined"!==typeof b&&a("html, body").animate({scrollTop:b.top-100-r},300)}catch(R){console.error(R)}};try{a.ajax({url:c.attr("action"),type:c.attr("method"),data:c.serializeArray(),success:function(b){if("undefined"===typeof b)return window.location.reload(),!1;if(0<b.indexOf("<title>Error</title>")){var e=
...
e+'-status" class="comment-posted">'+d.attr("data-posted")+"</span>"),f=b.children(".comment-content"),f.html(q(f.html(),g.owoData)),a("#"+h).replaceWith(b),Mlog("#comment-"+e+" img.avatar[data-src]"),a("#comment-"+e+" img.avatar[data-src]").each(function(){var b=a(this);G(b)})):a("#"+h+"-status").text(d.attr("data-posted")).removeClass("comment-posting").addClass("comment-posted")}d.removeAttr("disabled").val(d.attr("data-init"))},error:function(a){console.error(a);l();d.removeAttr("disabled").val(d.attr("data-init"))}})}catch(y$0){console.error(y$0)}}return!1})},
G=function(b){var c=b.attr("data-src"),d=b.attr("data-type")||0;b.attr("data-src","");var e=function(a){var c=new Image;c.src=a;c.onload=function(){b.attr("src",a)}};"json"===d?a.getJSON(c,null,function(a){e(a.url)}):e(c)},z=function(){if(LocalConst.SHOW_TOC){888>window.innerWidth&&(new Headroom(document.querySelector("#toggle-menu-tree"),{tolerance:5,offset:5,classes:{initial:"show",pinned:"show",unpinned:"hide"}})).init();document.body.onElementHeightChangeTimer&&clearTimeout(document.body.onElementHeightChangeTimer);
P(700,function(){S()});a("div.post-content>h1, div.post-content>h2, div.post-content>h3, div.post-content>h4, div.post-content>h5, div.post-content>h6").each(function(){a(this).append('<span class="toc">\u5c55\u5f00\u76ee\u5f55</span>');a(this).find("span.toc").click(function(c){0<a(this).css("opacity")&&b(c)})});var b=function(b){a("#wrap").removeClass("scale-up").removeClass("display-nav").toggleClass("display-menu-tree");a("body").removeClass("display-nav").toggleClass("display-menu-tree");a(this).removeClass("hide");
t();if(1E3>window.innerWidth){var c=a("#post");c.off("click").on("click",function(b){c.off("click");a("#wrap").removeClass("display-menu-tree").removeClass("display-nav");a("body").removeClass("display-menu-tree").removeClass("display-nav");b.preventDefault()});c.off("touchmove").on("touchmove",function(b){c.off("click");a("#wrap").removeClass("display-menu-tree").removeClass("display-nav");a("body").removeClass("display-menu-tree").removeClass("display-nav")})}};a("#toggle-menu-tree").off("click").on("click",
function(a){b(a)});k={};a('a.index-menu-link[href^="#menu_index_"]').each(function(){var b=a(this).attr("href");b.match(/menu_index_\d+/)&&(a(this).off("click").on("click",function(){u=!1;H(a(this));Page.scrollPageTo(b.substring(1),!0,function(){u=!0;t()});1E3>window.innerWidth&&(a("#wrap").removeClass("display-menu-tree").removeClass("display-nav"),a("body").removeClass("display-menu-tree").removeClass("display-nav"))}),k[parseInt(a(b).offset().top)]=b)});l=Object.keys(k);l=l.sort(function(a,b){return a-
b});a(".index-menu>.index-menu-list>li.index-menu-item").each(function(b){a(this).find(".index-menu-list").hide()})}},S=function(){LocalConst.SHOW_TOC&&(k={},a('a.index-menu-link[href^="#menu_index_"]').each(function(){var b=a(this).attr("href");b.match(/menu_index_\d+/)&&(k[parseInt(a(b).offset().top)]=b)}),l=Object.keys(k),l=l.sort(function(a,c){return a-c}))},t=function(){if(LocalConst.SHOW_TOC&&u){var b=v(),b=a(window).scrollTop()+100+b;20<b&&a("#toggle-menu-tree").removeClass("revert");if(a("#wrap").hasClass("display-menu-tree")){for(var c=
0,d=0;d<l.length;d++){var e=l[d];if(e<=b)c=k[e];else break}b=a('.index-menu-item>a.index-menu-link[href="'+c+'"]').first();a("#toc-content .index-menu>.index-menu-list").find(".index-menu-list").hide();b.parents(".index-menu-list").show();b.parent().children(".index-menu-list").show();H(b)}}},H=function(b){a('a.index-menu-link[href^="#menu_index_"]').each(function(){a(this).attr("href").match(/menu_index_\d+/)&&a(this).parent().removeClass("current")});b.parent().addClass("current")},q=function(a,
...
a.replace(b[0],'<img src="'+LocalConst.BIAOQING_ARU_PATH+encodeURI(b[1]).replace(/%/g,"")+e+'.png" class="biaoqing alu" height=33 width=33 no-zoom />');a=T(a,c);"function"===typeof customRenderSmiles&&(a=customRenderSmiles(a));return a},T=function(a,c){if("undefined"!==typeof c)return a=a.replace(/::([^:]+):([^:]+)::/g,function(a,b,f){var d=c[b];if("undefined"===typeof d||!d.icons.includes(f))return a;a=LocalConst.BASE_SCRIPT_URL+"usr/biaoqing/"+d.name+"/";var e=d.suffix;void 0!=window.devicePixelRatio&&
1.49<=window.devicePixelRatio&&(e=d.retinaSuffix);return'<img src="'+(a+f+e)+'" class="'+("biaoqing "+d.imgClass)+'" alt="'+(b+" "+f)+'">'})},B=function(){var b=document.getElementsByClassName("OwO")[0],c=document.getElementById("textarea"),d=function(b){for(var c={},d=0;d<b.packages.length;d++)if("usr"===b.odata[b.packages[d]].type){for(var e=b.odata[b.packages[d]],f=e.container,h=[],k=0;k<f.length;k++){var n=f[k];"undefined"!==typeof n&&("string"===typeof n?h.push(n):"string"===typeof n.icon&&h.push(n.icon))}e.icons=
h;c[e.name]=e}g.owoData=c;a("#comments").find(".comment-content>p").each(function(b,d){a(d).html(q(a(d).html(),c))});var l=function(){Mlog("Rendering smiles in content...");a("#wrap").find(".post-content>p").each(function(b,d){a(d).html(q(a(d).html(),c))})};"undefined"!==typeof MathJax?MathJax.Hub.Queue(function(){l()}):l()};void 0!==b&&void 0!==c&&new OwO({logo:"O\u03c9O",container:b,target:c,api:LocalConst.OWO_API,position:"down",style:"max-width: 100%;",maxHeight:"250px",completeFunction:d})},
Q=function(b){return a("<div/>").text(b).html()},p=function(a,c,d){var b=new Date;b.setDate(b.getDate()+d);document.cookie=a+"="+encodeURIComponent(c)+(null===d?"":";expires="+b.toGMTString())+";path=/"},F=function(){a("#nav-side-toolbar-read-settings").parent().removeClass("selected");a(".navbar-nav.side-toolbar-list").removeClass("show-read-settings")},A=function(){a("#nav-side-toolbar-read-settings").off("click").on("click",function(b){var c=a(".navbar-nav.side-toolbar-list"),d=a(this);if(c.hasClass("show-read-settings"))d.parent().removeClass("selected"),
...
b.addClass("show-read-settings"))});a("#page-read-setting-toggle").off("click").on("click",function(b){a("#toggle-nav").trigger("click");b=a("#nav-toolbar").find(".side-toolbar");a("#side-toolbar-read-settings").parent().addClass("selected");b.addClass("show-read-settings")})},M=function(){var b=a("body");a("a.background-color-control").off("click").on("click",function(c){a("a.background-color-control").removeClass("selected");a(this).addClass("selected");c=a(this).attr("data-mode");if("auto"===c){c=
a("#side-toolbar-night-shift");LocalConst.AUTO_NIGHT_SHIFT=!0;var d=(new Date).getHours();5>=d||22<=d||LocalConst.PREFERS_DARK_MODE?(b.removeClass("theme-white").removeClass("theme-sunset").addClass("theme-dark"),c.addClass("night"),c="theme-dark"):(b.removeClass("theme-dark").removeClass("theme-sunset").addClass(LocalConst.LIGHT_THEME_CLASS),c="theme-white");p("MIRAGES_NIGHT_SHIFT_MODE","AUTO");b.trigger("mirages:theme-change",[{auto:!0,theme:c}])}else"white"===c?(b.removeClass("theme-dark").removeClass("theme-sunset").addClass(LocalConst.LIGHT_THEME_CLASS),
p("MIRAGES_NIGHT_SHIFT_MODE","DAY"),LocalConst.AUTO_NIGHT_SHIFT=!1,b.trigger("mirages:theme-change",[{auto:!1,theme:"theme-white"}])):"sunset"===c?(b.removeClass("theme-dark").addClass(LocalConst.LIGHT_THEME_CLASS).addClass("theme-sunset"),p("MIRAGES_NIGHT_SHIFT_MODE","SUNSET"),LocalConst.AUTO_NIGHT_SHIFT=!1,b.trigger("mirages:theme-change",[{auto:!1,theme:"theme-sunset"}])):"dark"===c&&(b.removeClass("theme-white").removeClass("theme-sunset").addClass("theme-dark"),p("MIRAGES_NIGHT_SHIFT_MODE","NIGHT"),
LocalConst.AUTO_NIGHT_SHIFT=!1,b.trigger("mirages:theme-change",[{auto:!1,theme:"theme-dark"}]))})},N=function(){a("button.font-family-control").off("click").on("click",function(b){b=a(this).attr("data-mode");"serif"===b?Page.switchToSerifFonts():"sans-serif"===b&&Page.switchToSansSerifFonts()})},D=function(b){setTimeout(function(){a(".sp-progress").css("opacity","0")},b||0)},O=function(){var b=a(".font-size-display"),c=function(c){var d=parseFloat(a(".font-size-display").first().text());c=d+c;if(!(80>
c||150<c)){if(100<d&&100>c||100>d&&100<c)c=100;a("html").css("font-size",c+"%");b.text(c+"%");p("MIRAGES_ROOT_FONT_SIZE",c)}};(function(){var c=a("html").css("font-size"),c=parseFloat(c)/16*100;80>c&&(c=LocalConst.ROOT_FONT_SIZE,console.log(LocalConst.ROOT_FONT_SIZE));c=Math.round(c);b.text(c+"%")})();a(".font-size-control").off("click").on("click",function(b){b=a(this).attr("data-mode");"smaller"===b?c(-5):"larger"===b&&c(5)})},U=function(){a("pre code:not(.nohighlight)").each(function(){var b=a(this).html();
LocalConst.TRIM_LAST_LINE_BREAK_IN_CODE_BLOCK&&b.endsWith("\n")&&(b=b.substring(0,b.length-1));a(this).html("<ul><li><div class='code-line'>"+b.replace(/\n/g,"\n</div></li><li><div class='code-line'>")+"\n</div></li></ul>");a(this).parent("pre").addClass("loaded")})},V=function(){var b=new Date;window.asyncBannerLoadNum=0;window.asyncBannerLoadCompleteNum=0;window.asyncImageLoadNum=0;window.asyncImageLoadCompleteNum=0;var c=function(a){Mlog(a.type.toUpperCase());if(window.asyncBannerLoadNum===window.asyncBannerLoadCompleteNum&&
window.asyncImageLoadNum===window.asyncImageLoadCompleteNum&&window.asyncBannerLoadNum===window.asyncImageLoadNum&&-1170===window.asyncImageLoadNum){var c=new Date-b;Mlog("All Done["+c+"ms]["+a.type.toUpperCase()+"]");D(1170>c?1170-c:0)}};a("body").off("ajax-image:done").on("ajax-image:done",c).off("ajax-banner:done").on("ajax-banner:done",c)};window.Page={setupLazyLoadImage:function(){a("section.lazy-load").each(function(){0<=window.asyncImageLoadNum&&(window.asyncImageLoadNum++,Mlog("Loading..."+
window.asyncImageLoadNum));var b=a(this),c=b.find(".progressiveMedia"),d=c.find(".img-small"),e=b.attr("data-"+LocalConst.KEY_CDN_TYPE),e=getImageAddon(e),f=new Image;f.src=d.attr("data-src")+e;f.classList.add("img-large");a(f).attr("no-zoom",!0);f.onload=function(){c.addClass("large-image-loaded");setTimeout(function(){a(f).addClass("loaded").attr("data-action","zoom").removeAttr("no-zoom").removeAttr("width").removeAttr("height").css("height","").attr("data-shadow",b.attr("data-shadow"));b.replaceWith(a(f));
0<=window.asyncImageLoadCompleteNum&&(window.asyncImageLoadCompleteNum++,Mlog("Loaded: "+window.asyncImageLoadCompleteNum),window.asyncImageLoadCompleteNum===window.asyncImageLoadNum&&(window.asyncImageLoadNum=-1170,window.asyncImageLoadCompleteNum=-1170,a("body").trigger("ajax-image:done")))},1001)};c.append(f)});isNaN(window.asyncImageLoadNum)||0!==window.asyncImageLoadNum||(Mlog("Async Image Nothing to Load"),window.asyncImageLoadNum=-1170,window.asyncImageLoadCompleteNum=-1170,a("body").trigger("ajax-image:done"))},
setupCDNImageOptimize:function(){a("article img:not(code img, pre img, .lazy-load img)").each(function(){var b=a(this).attr("data-src"),c=a(this).attr("data-"+LocalConst.KEY_CDN_TYPE);null!==b&&void 0!==b&&""!==b&&(c=getImageAddon(c),a(this).attr("src",b+c),a(this).removeAttr("data-src"))})},loadDisqus:function(){if(a("#disqus_thread").length)if(window.DISQUS)DISQUS.reset({reload:!0});else{var b=document.createElement("script");b.type="text/javascript";b.async=!0;b.src="//"+LocalConst.DISQUS_SHORT_NAME+
".disqus.com/embed.js";(document.getElementsByTagName("head")[0]||document.getElementsByTagName("body")[0]).appendChild(b)}},scrollPageTo:function(b,c,d){var e=v();b=isNaN(b)?a("#"+b).offset().top-e:b;c=void 0!==c&&!0===c?600:0;a("body,html").animate({scrollTop:b},c);"function"===typeof d&&setTimeout(function(){d()},c);return!1},autoScrollPage:function(){var a=location.hash.indexOf("#");0>a||(a=window.location.hash.substring(a+1),this.scrollPageTo(a))},setupContents:function(){a("article img:not(article .link-box img, img[no-zoom])").each(function(){a(this).attr("data-action",
"zoom");a(this).next().is("br")&&a(this).next().remove()});a(".post-content a:not(code a, pre a), #content a:not(code a, pre a), #comments a").each(function(){var b=a(this).attr("href");b.startWith("http")&&!b.startWith(location.origin)&&a(this).attr("target","_blank")});a(".post-content p.more a").each(function(){a(this).removeAttr("target")});a("li.task-list-item").each(function(){var b=a(this).parent();b.hasClass("task-list")||b.addClass("task-list")});try{a(".post-content table").wrap("<div class='table-responsive'></div>"),
a(".post-content embed.video, .post-content video.video, .post-content iframe.video").addClass("video-4-3"),a(".post-content embed[video], .post-content video[video], .post-content iframe[video]").addClass("video-4-3"),a(".post-content embed[video-4-3], .post-content video[video-4-3], .post-content iframe[video-4-3]").addClass("video-4-3"),a(".post-content embed[video-16-9], .post-content video[video-16-9], .post-content iframe[video-16-9]").addClass("video-16-9"),a(".post-content embed, .post-content video, .post-content iframe").each(function(){0!==
this.style.height.length&&(a(this).hasClass("video-4-3")||a(this).hasClass("video-16-9")||a(this).attr("not-video",""))}),a(".post-content embed:not([not-video], [height], .video-4-3, .video-16-9, .large-content), .post-content video:not([not-video], [height], .video-4-3, .video-16-9, .large-content), .post-content iframe:not([not-video], [height], .video-4-3, .video-16-9, .large-content)").addClass("video-4-3"),a(".post-content embed.video-4-3, .post-content video.video-4-3, .post-content iframe.video-4-3").removeClass("video-16-9").wrap("<div class='video-container video-4-3'></div>"),
a(".post-content embed.video-16-9, .post-content video.video-16-9, .post-content iframe.video-16-9").wrap("<div class='video-container video-16-9'></div>"),a(".post-content iframe, .post-content embed").each(function(){var b=a(this);b&&!b.attr("src")&&b.attr("data-src")&&b.attr("src",b.attr("data-src"))}),a(".post-content object").each(function(){var b=a(this);b&&!b.attr("data")&&b.attr("data-delay")&&b.attr("data",b.attr("data-delay"))})}catch(b){console.error(b)}a(".content-tab-title").off("click").on("click",
function(b){var c=a(this),d=c.parent();b=d.parent();var e=c.attr("data-tab-index");b.find(".content-tab-title").each(function(){a(this).attr("data-tab-index")===e?a(this).addClass("selected"):a(this).removeClass("selected")});b.find(".content-tab-content").each(function(){a(this).attr("data-tab-index")===e?a(this).addClass("selected"):a(this).removeClass("selected")});b=function(a){0>a&&(a=0);try{a>d[0].scrollWidth-d.innerWidth()&&(a=d[0].scrollWidth-d.innerWidth())}catch(r){console.error(r)}Mlog("scrollTabTo: ",
a);d.animate({scrollLeft:a},500)};if(!LocalConst.IS_MOBILE){var f=d.offset().left,g=c.offset().left,h=d.innerWidth(),c=c.outerWidth(),k=d.scrollLeft();b(g+k-f-(h-c)/2)}});a(".search-form-input").on("click focus",function(b){"undefined"!==typeof INSIGHT_CONFIG&&(a("body").removeClass("display-nav"),a("#wrap").removeClass("display-nav"))});a("#comments img.avatar[data-src]").each(function(){var b=a(this);G(b)})},prepareCodeBlock:function(){LocalConst.HIDE_CODE_LINE_NUMBER||U()},highlightCodeBlock:function(){LocalConst.ENABLE_FLOW_CHART&&
a("pre>code.lang-flow").each(function(b){a(this).addClass("nohighlight").attr("data-flow-chart-index",b).parent().addClass("display-none").after('<div id="flow-chart-'+b+'" class="flow-chart"></div>')});LocalConst.ENABLE_MERMAID&&a("pre>code.lang-mermaid").each(function(b){a(this).addClass("nohighlight").attr("data-mermaid-index",b).parent().addClass("display-none").after('<div id="mermaid-'+b+'" class="mermaid-content"></div>')});this.prepareCodeBlock();a("pre code").each(function(a,c){hljs.highlightBlock(c)})},
resetStates:function(){g.flowChartTheme="";g.mermaidTheme="";g.mermaidIndex=0;a("body").off("mirages:theme-change")},renderFlowChart:function(){if(LocalConst.ENABLE_FLOW_CHART){var b=function(){var b=2;void 0!==window.devicePixelRatio&&1.49<=window.devicePixelRatio&&(b=1.5);var d={x:0,y:0,"line-width":b,"text-margin":15,"font-size":13,font:"normal","font-family":'Consolas, Menlo, Monaco, "lucida console", "Liberation Mono", "Courier New", "andale mono", monospaceX, sans-serif',"font-weight":"normal",
fill:"none","yes-text":"yes","no-text":"no","arrow-end":"block",scale:1},b="white";a("body").hasClass("theme-dark")&&(d["line-color"]="white",d["element-color"]="white",d["font-color"]="white",b="dark");g.flowChartTheme===b?Mlog("FlowChart Theme Not Change. Skip Render..."):(g.flowChartTheme=b,a("pre>code.lang-flow").each(function(){var b=a(this).attr("data-flow-chart-index"),c=this.innerText;if("undefined"!==typeof c)try{var b="flow-chart-"+b,f=flowchart.parse(c),g=document.querySelector("#"+b);
g?(g.innerHTML="",f.drawSVG(b,d)):console.warn("FlowChart Target: "+b+" Not Exists!")}catch(x){console.error(x)}}))};b();a("body").on("mirages:theme-change",function(a,d){b()})}},renderMermaid:function(){if(LocalConst.ENABLE_MERMAID){var b=function(){var b="forest";a(body).hasClass("theme-dark")&&(b="dark");if(g.mermaidTheme===b)Mlog("Mermaid Theme Not Change. Skip Render...");else{g.mermaidTheme=b;var d=a("body")[0].offsetWidth;768>d&&(d=768);mermaid.mermaidAPI.initialize({startOnLoad:!1,theme:b,
gantt:{useWidth:d}});g.mermaidIndex||(g.mermaidIndex=0);g.mermaidIndex++;a("pre>code.lang-mermaid").each(function(){var b=a(this).attr("data-mermaid-index"),c=this.innerText,b="mermaid-"+b,d=b+"-svg-"+g.mermaidIndex;if("undefined"!==typeof c)try{var f=document.querySelector("#"+b);mermaid.mermaidAPI.render(d,c,function(a,b){f.innerHTML=a;b(f);var c=document.querySelector("#"+d);c.style.fontWeight=400;var e=c.getAttribute("viewBox");if(e){if(e=e.split(/\s+/),4===e.length){var g=parseInt(e[0],10),e=
parseInt(e[2],10)-g;0<e&&(c.style.maxWidth=e+"px",c.style.minWidth=.75*e+"px")}}else e=.75*parseInt(c.style.maxWidth,10),0<e&&(c.style.minWidth=e+"px")})}catch(x){console.error(x)}})}};b();a("body").on("mirages:theme-change",function(a,d){b()})}},resetStatus:function(){a("#wrap").removeClass("display-nav").removeClass("display-menu-tree");a("#footer").removeClass("display-nav");a("#body").off("click");a("body").removeClass("show-reward-qr-box").removeClass("show-post-qr-box").removeClass("display-nav").removeClass("display-menu-tree");
...
dPlayerOptions[c].id);"undefined"!==typeof d&&null!==d&&(dPlayers[c]=new DPlayer({element:d,autoplay:dPlayerOptions[c].autoplay,video:dPlayerOptions[c].video,theme:dPlayerOptions[c].theme,danmaku:dPlayerOptions[c].danmaku}))}},switchToSerifFonts:function(){p("MIRAGES_USE_SERIF_FONTS","1");if(!g.serifFontLoaded){if("undefined"===typeof WebFontConfig){window.WebFontConfig={google:{families:["Noto Serif SC:400,700&amp;subset=chinese-simplified,japanese"]},timeout:3E3};var b=document.createElement("script"),
c=document.scripts[0];b.src=LocalConst.BASE_SCRIPT_URL+"static/webfont/1.6.24/webfontloader.js";c.parentNode.insertBefore(b,c)}else b=document.createElement("link"),b.setAttribute("rel","stylesheet"),b.href="https://fonts.googleapis.com/css?family=Noto+Serif+SC:400,700&amp;subset=chinese-simplified,japanese",document.head.appendChild(b);g.serifFontLoaded=!0}a("body").addClass("serif-fonts");a(".font-family-control").removeClass("selected");a(".font-family-control.control-btn-serif").addClass("selected")},
switchToSansSerifFonts:function(){p("MIRAGES_USE_SERIF_FONTS","");a("body").removeClass("serif-fonts");a(".font-family-control").removeClass("selected");a(".font-family-control.control-btn-sans-serif").addClass("selected")},showReadSettings:function(a){p("SHOW_READ_SETTINGS",a)},doPJAXClickAction:function(){V();a("body").attr("data-prev-href",document.location.pathname+document.location.search+document.location.hash).removeClass("display-menu-tree");a("#wrap").removeClass("display-menu-tree");LocalConst.PJAX_LOAD_STYLE===
LocalConst.PJAX_LOAD_STYLE_SIMPLE&&a(".sp-progress").css("opacity","1")},doPJAXSendAction:function(){LocalConst.PJAX_LOAD_STYLE!==LocalConst.PJAX_LOAD_STYLE_SIMPLE&&LocalConst.PJAX_LOAD_STYLE===LocalConst.PJAX_LOAD_STYLE_CIRCLE&&a("#loader-wrapper").addClass("in");Page.resetStatus()},doPJAXCompleteAction:function(){Page.resetStates();LocalConst.PJAX_LOAD_STYLE!==LocalConst.PJAX_LOAD_STYLE_SIMPLE&&LocalConst.PJAX_LOAD_STYLE===LocalConst.PJAX_LOAD_STYLE_CIRCLE&&a("#loader-wrapper").removeClass("in");
A();var b=a("body"),c=b.attr("data-prev-href"),d=document.location.pathname+document.location.search+document.location.hash;_czc.push(["_trackPageview",d,c]);_hmt.push(["_trackPageview",d]);pangu.spacingElementByClassName("container");isNaN(window.asyncBannerLoadNum)||0!==window.asyncBannerLoadNum||(Mlog("Async Banner Nothing to Load"),window.asyncBannerLoadNum=-1170,window.asyncBannerLoadCompleteNum=-1170,b.trigger("ajax-banner:done"));this.setupLazyLoadImage();this.setupCDNImageOptimize();this.setupContents();
this.highlightCodeBlock();this.bindQRCodeBlockEvents();this.autoScrollPage();z();this.renderFlowChart();this.renderMermaid();this.reInitAPlayer();this.reInitDPlayer();LocalConst.COMMENT_SYSTEM===LocalConst.COMMENT_SYSTEM_DISQUS?this.loadDisqus():LocalConst.COMMENT_SYSTEM===LocalConst.COMMENT_SYSTEM_EMBED&&(C(),B());"undefined"!==typeof MathJax&&MathJax.Hub.Queue(["Typeset",MathJax.Hub,"body"])}};String.prototype.startWith=function(a){return null===a||""===a||0===this.length||a.length>this.length?
!1:this.substr(0,a.length)===a}})(jQuery);/*
